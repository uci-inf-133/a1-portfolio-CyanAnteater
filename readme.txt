...
Yes I ignored a decent amount of "potential problems" from AChecker. A lot of the "potential problems" it flagged across my 3 pages were similar (ie those generated from my navbar, which exists across all 3 pages) so there are duplicate “potential problems” that were flagged.
